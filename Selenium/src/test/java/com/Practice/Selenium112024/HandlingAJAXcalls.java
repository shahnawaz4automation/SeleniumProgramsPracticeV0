...
public class HandlingAJAXcalls {
	...
	public static void main(String[] args) throws IOException, InterruptedException {
		...
		// WebElement loadedElement =
		// driver.findElement(By.xpath("//div[@id='ajaxContent']/h2"));

		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
		WebElement loadedElement = wait
		 ...
		 * (Exception e) { System.out.println("Error while quitting driver: " +
		 * e.getMessage()); } }
		 */
	}
}